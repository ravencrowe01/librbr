...
namespace librbr.World.Chunk {
    public class ChunkBuilder : IChunkBuilder {
        ...
        public IChunkConfig BuildChunk (IChunkValidator validator, IRNGProvider rng, int seed) {
            _rng = rng;
        ...
        private IRoomConfig ConstructRoom (int x, int z, int seed, Coordinate center) {
            var room = new ProtoRoom();
            room.Coordinates = new Coordinate(x, z);
